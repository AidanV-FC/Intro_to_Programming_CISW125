...
fav_game="Quake"
recently_played="Amid Evil"
underrated_game="Doom 3"

# Then print your variables.
print(fav_game)
print(recently_played)
print(underrated_game)
...
print(f"One of my favorite games of all time is {fav_game} I love the bullet-time mechanic.")
print(f"I've been recently playing through {recently_played}. It's got some of the most-tightly designed combat in any game I've played.")
print(f"Many people don't hold this game in high regards, but I think {underrated_game} is actually pretty good.")
